...
TEST_FUNCTION(test_bitwise_and_int64) {
  // Basic int64 AND
  TEST_INTERPRET("4294967296 4294967296 &");  // 2^32
  TEST_STACK_DEPTH(1);
  TEST_STACK_TOP_INT(4294967296);
  TEST_INTERPRET("CELL-TYPE");
...
TEST_FUNCTION(test_bitwise_and_mixed_types) {
  ...
  TEST_STACK_DEPTH(1);
  TEST_STACK_TOP_INT(0);  // 15 & 2^32 = 0
  TEST_INTERPRET("CELL-TYPE");
  TEST_STACK_TOP_INT(1);  // CELL_INT64
  TEST_INTERPRET("DROP");
  ...
  TEST_STACK_TOP_INT(1);              // Only low bit matches
  TEST_INTERPRET("CELL-TYPE");
  TEST_STACK_TOP_INT(1);  // CELL_INT64
  TEST_INTERPRET("DROP");
  TEST_STACK_DEPTH(0);
...
TEST_FUNCTION(test_bitwise_or_int64) {
  ...
  TEST_STACK_DEPTH(1);
  TEST_STACK_TOP_INT(4294967297);  // 2^32 + 1
  TEST_INTERPRET("CELL-TYPE");
  TEST_STACK_TOP_INT(1);  // CELL_INT64
  TEST_INTERPRET("DROP");
  TEST_STACK_DEPTH(0);
...
TEST_FUNCTION(test_bitwise_or_mixed_types) {
  ...
  TEST_INTERPRET("15 4294967296 |");
  TEST_STACK_DEPTH(1);
  TEST_STACK_TOP_INT(4294967311);  // 2^32 + 15
  TEST_INTERPRET("CELL-TYPE");
  TEST_STACK_TOP_INT(1);  // CELL_INT64
  TEST_INTERPRET("DROP");
  TEST_STACK_DEPTH(0);
...
TEST_FUNCTION(test_left_shift_valid) {
  ...
  TEST_INTERPRET("4294967296 1 <<");  // 2^32 << 1
  TEST_STACK_TOP_INT(8589934592);     // 2^33
  TEST_INTERPRET("CELL-TYPE");
  TEST_STACK_TOP_INT(1);  // CELL_INT64
  TEST_INTERPRET("DROP");
  TEST_STACK_DEPTH(0);
...
TEST_FUNCTION(test_right_shift_valid) {
  ...
  TEST_STACK_TOP_INT(4294967296);     // 2^32
  TEST_INTERPRET("CELL-TYPE");
  TEST_STACK_TOP_INT(1);  // CELL_INT64
  TEST_INTERPRET("DROP");
  TEST_STACK_DEPTH(0);
